...
local function furnace_node_timer(pos, elapsed)
	...
	if fuel_totaltime ~= 0 then
		...
		formspec = default.get_secheviande_active_formspec(fuel_percent, item_percent)
...
--		end
		...
		formspec = default.get_secheviande_inactive_formspec()
...
minetest.register_node(mod_name .. ":secheviande_dry", {
	description = S("Seche viande avec viande séchée"),
	drawtype="mesh",
...
minetest.register_node(mod_name .. ":secheviande_vide", {
	description = S("Seche viande vide"),
	drawtype="mesh",
	mesh="portique_viande.obj",
	paramtype = "light",
	paramtype2 = "facedir",
